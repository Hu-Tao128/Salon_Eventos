...
public class AgregarTiposServicios {
    public void agregarTiposServiciosF(){
        ...
        System.out.println("Registro de un tipo de servicio");

        do{
            System.out.println("Quieres agregar un tipo de servicio? (s/n)");
        ...
        if(opcion3.equals("s")){
            do {
                ...
                System.out.println("Nombre del tipo de servicio");
            ...
            try {
                ...
                if (filasAfectadas > 0) {
                    System.out.println("Los datos se han insertado correctamente en la tabla tipo_servicios.");
                } else {
                    System.out.println("No se pudo insertar los datos en la tabla tipo_servicios.");
                }
